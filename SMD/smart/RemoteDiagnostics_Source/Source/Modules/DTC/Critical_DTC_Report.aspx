<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Critical_DTC_Report.aspx.cs" Inherits="Modules_DTC_Critical_DTC_Report" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <section class="content-header">
        <h1>Critical DTC Report Card</h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-table"></i>Reports</a></li>
            <li class="active">Critical DTC Report Card</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <asp:GridView ID="gvFreezeView" runat="server" AutoGenerateColumns="false" Width="100%" DataKeyNames="freeze_MASTER_ID" OnRowDataBound="gvFreezeView_RowDataBound"
                            CssClass="table table-condensed table-striped table-hover table-bordered" ShowHeaderWhenEmpty="true" ClientIDMode="Static">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Vehicle Name" DataField="crt_PLATFORM_NAME" />
                                <asp:BoundField HeaderText="ECU Name" DataField="crt_ECU_NAME" />
                                <asp:BoundField HeaderText="DTC Code" DataField="crt_DTC_CODE" />
                                <asp:TemplateField HeaderText="Occurrence Counter" ItemStyle-Wrap="true" ItemStyle-Height="1px" HeaderStyle-Height="1px">
                                    <ItemTemplate>
                                        <span>
                                            <%#getCriticalDTCCount(Eval("crt_DTC_CODE"),Eval("freeze_VIN_NUMBER"))%>
                                        </span>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Push Notification Status" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate><%# (Boolean.Parse(Eval("freeze_PUSH_NOTIFY").ToString())) ? "Yes" : "No" %></ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField HeaderText="Notification Counter" DataField="freeze_NOTIFY_COUNTER" />
...
$('#<%=txtSDate.ClientID %> ').datepicker({
        ...
        function showModal(Param) {
            ...
            $.ajax({
                type: "POST",
                <%--url: '<%= ResolveUrl("Critical_DTC_Report.aspx/GetDTC") %>',--%>
